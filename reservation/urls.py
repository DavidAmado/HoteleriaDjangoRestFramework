...
from .views import ReservationViewSet, RoomViewSet, ReservationCheckIn, ReservationCheckOut, ReservationCancelled, IsRoomsAviable
...
urlpatterns = [
    ...
    path('api/reservations/<int:reservation_id>/cancelled/', ReservationCancelled.as_view()),
